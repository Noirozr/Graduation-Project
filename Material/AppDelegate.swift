...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        if let data: AnyObject = NSUserDefaults.standardUserDefaults().objectForKey("DSP") {
            ...
            NSUserDefaults.standardUserDefaults().setObject(dData, forKey: "DSP")
        }
        
        if let data: AnyObject = NSUserDefaults.standardUserDefaults().objectForKey("ASP") {
            ...
            let aData = [0, 0, 0, 0, 0]
            NSUserDefaults.standardUserDefaults().setObject(aData, forKey: "ASP")
        }
